...
*************************************************** **/
	...
	jQuery(window).ready(function () {
		...
		if(no_lpp){
			// loadScript(plugin_path + "formatter.js");
			loadScript(plugin_path + "ajaxupload.3.5.js");
			loadScript(plugin_path + "jquery.imgupload.js");
			loadScript(plugin_path + "jquery.form.js");
			loadScript(plugin_path + "jquery-validation-1.15.0/dist/jquery.validate.min.js");
			loadScript(plugin_path + "smoothproducts.min.js");
			
			setTimeout(function() { loadScript(plugin_path + "landing_page.js"); }, 100);
		}

		// Load Bootstrap JS
		loadScript(plugin_path + 'bootstrap/js/bootstrap.min.js', function() { Init(false); });
		/* --- */
